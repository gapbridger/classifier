...
class MultiLayerPerceptron(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        self.params = self.hiddenLayer.params + self.logRegressionLayer.params # addition of two lists
        self.input = input


def test_multilayer_perceptron(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
